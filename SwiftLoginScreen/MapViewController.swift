...
class MapViewController: UIViewController, MKMapViewDelegate, UIViewControllerTransitioningDelegate, UIPopoverPresentationControllerDelegate, HasAppServices {
    // MARK: Lifecycle
...
extension MapViewController: @MainActor HandleMapSearch {
...
extension MapViewController: @MainActor CLLocationManagerDelegate {
